...
export const industry = [
	{
		...
		body: " Elytse's Sell, Rent, and Swap feature is a great way to save money on fashion. You can sell your gently used pre-owned fashion items to other users, swap them for items you like better, or rent them for a short period of time. This is a great way to get new fashion items without spending a lot of money.",
		img: sell,
	...
	},
	{
		...
		body: "Elytse's Real-Time monitoring feature for service providers gives users peace of mind. With the push of a button, you can see how far your service provider has gone with producing your order and how much time left. This transparency helps to build trust and satisfaction.",
		img: Real,
		button:"Join Now!",
	},
