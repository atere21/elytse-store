  ...
  return (
    <div className="text-blue-600 mx-auto w-[100vw] h-full flex  flex-col  bg-white  items-center md:py-2 p-8 md:p-16 mb-[-4rem]">
      ...
      <div className="flex flex-col sm:flex-row-reverse  w-[100%] sm:bg-white p-2 ">
        ...
        >
          <p className="sm:block hidden text-l text-left text-blue-600 font-bold pb-1 pt-1 mb-2 border-b-4 sm:border-b-0 sm:w-full w-[150px] border-blue-900 m-auto text-xl md:text-2xl">
            {card.title}
          </p>
          <p className="duration-150 ease-out ">{card.body}</p>

          <button
            className="duration-150 ease-out md:my-[10rem] my-[4rem]
